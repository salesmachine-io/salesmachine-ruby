...
describe SalesMachine::Track do
	...
	it 'should send tracker data' do
		SalesMachine::Track.pageview("test@acme.com", {:location => "/home", :user_ip => "127.0.0.1", :user_agent => "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.4 Safari/537.36"})
	end
end